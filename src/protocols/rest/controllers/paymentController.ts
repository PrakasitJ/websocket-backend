import { PaymentService } from "../../websocket/middleware/paymentService";
import { CurrencyUnit, IPaymentConfig } from "../../../core/interfaces/index";
...
class PaymentController {
    ...
    public static getInstance() {
        if (!PaymentController.instance) {
            ...
            }, WebSocketServer.getInstance().getIO()));
        }
