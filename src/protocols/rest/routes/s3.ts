...
import { S3Service } from "../../../middleware/s3Service";
import { IFileResponse } from "../../../core/interfaces/index";

const s3 = new Elysia({
    prefix: "/s3"
});

function createFileResponse(success: boolean, message: string, file: File | string | null): IFileResponse {
    return {
        success,
        message,
        file
